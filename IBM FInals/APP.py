...
class Prediction_Window(Screen):
    def __init__(self, **kwargs):
        ...
        self.btn7 = Button(text='Predict (Hold to see suggestion)',background_color = (0.9,0.1,0.2,0.8), size_hint=(.9, .1), pos_hint={'center_x': .5, 'y': .40})
...
#---------------------------Scrape--------------------------------------------
        ...
        wind_final=[i.strip(" ") for i in hehe8]
        #comment final#----------------------------------------------------------------------------------------------------------
...
class Setup_Window(Screen):
    def __init__(self, **kwargs):
        ...
        self.add_widget(Label(text="Setup Compelete!",color=(0,0,0,1),font_size=(20)))
...
class Guide_Window(Screen):
    def __init__(self, **kwargs):
        ...
        with open("Guide.txt") as f:
            contents = f.read()
        self.add_widget(Label(text=contents,color=(0,0,0,1),font_size=(20)))
        self.btn6 = Button(text='Goo back!',background_color = (0.9,0.1,0.2,1), size_hint=(.5, .1), pos_hint={'center_x': .5, 'y': .03})
        self.add_widget(self.btn6)
        self.btn6.bind(on_press = self.screen_transition)
    def screen_transition(self, *args):
...
class Application(App):
    def build(self):
        Window.clearcolor = (1,1,1,1)
        Window.add_widget((AsyncImage(source="https://images.unsplash.com/photo-1505672678657-cc7037095e60?ixlib=rb-1.2.1&auto=format&fit=crop&w=1500&q=80",size_hint=(1.5395,1.37))))
